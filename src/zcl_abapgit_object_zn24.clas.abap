class ZCL_ABAPGIT_OBJECT_ZN24 definition
  public
...
CLASS ZCL_ABAPGIT_OBJECT_ZN24 IMPLEMENTATION.
...
*               iv_package               = iv_package
  ...
  method zif_abapgit_object~map_object_to_filename.
    ...
    field-symbols: <la_cons_value> type any.
    ...
    assign ('/NEPTUNE/IF_ARTIFACT_TYPE=>GC_ARTIFACT_TYPE-TILEGROUP_LAYOUT') to <la_cons_value>.
    if <la_cons_value> is not assigned.
    ...
    zcl_neptune_abapgit_utilities=>map_object_to_filename(
      exporting is_item                  = is_item
                ...
                iv_artifact_type         = <la_cons_value>
