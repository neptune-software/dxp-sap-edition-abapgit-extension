class zcl_abapgit_object_zn12 definition
  public
...
CLASS ZCL_ABAPGIT_OBJECT_ZN12 IMPLEMENTATION.
...
* Remove unwanted fields
  ...
  method zif_abapgit_object~changed_by.
    ...
    data ls_splash type /neptune/splash.
    ...
    if sy-subrc = 0.
      ...
      check sy-subrc = 0.
      read table <lt_standard_table> into ls_splash index 1.
      if sy-subrc = 0 and ls_splash-updnam is not initial.
        rv_user = ls_splash-updnam.
      else.
        rv_user = ls_splash-crenam.
      endif.
    endif.
...
*          call method  /neptune/cl_tadir=>get_artifact_entry
          exporting
            ...
            iv_artifact_type = /neptune/if_artifact_type=>gc_artifact_type-splash
          receiving
